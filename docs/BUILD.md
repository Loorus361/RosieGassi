...
App **Rosie Gassi**, Bundle `de.carlosanderssohn.RosieGassi`, Extension `de.carlosanderssohn.RosieGassi.LiveActivity`, bestehendes Team `U8257B63WL`. Version 0.1.0, Build 14 für beide Targets in `project.yml`. Auf Fred nachgewiesen: 0.1.0, Build 14 (Geräte-Metadaten vom 16.09.2026). IDs, Team und Datenformat für ein datenerhaltendes Update erhalten.
